...
#Result = Accuries - .844 and Variance - 0.02, So we can say our model is low variance and low bias
...
#Result = best parameter is batch size=25, nb_epoch=500, optimizer = rmsprop
# Best accuracy = .85
